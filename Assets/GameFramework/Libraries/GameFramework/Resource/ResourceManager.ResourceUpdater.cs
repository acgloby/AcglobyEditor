...
namespace GameFramework.Resource
{
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            //这里的资源是都是马上就要更新的  --by 王凯
            private readonly List<UpdateInfo> m_UpdateWaitingInfo;
            //候选更新列表 把需要更新的资源信息先存在这里, 1.需要从服务器下载的资源 2.下载失败的资源。启动后检查更新 or 失败重试触发更新。
            ...
            //本地资源信息文件 每次更新完资源重新写入这个文件 --by 王凯
            private string m_ReadWriteVersionListFileName;
            //楼上文件的副本 存在的目的是当我们在操作m_ReadWriteVersionListFileName这个文件时 起到一个备份的作用 防止写入失败导致原文件丢失 可以看看引用就知道了 --by 王凯
            ...
            public void UpdateResources(ResourceGroup resourceGroup)
            {
                ...
                {
                    //到这里 把候选更新列表里的全部资源进行更新 并清空候选更新列表  --by 王凯
                ...
                {
                    //到这里 就是更新 候选更新列表的&&指定资源组里的 资源   --by 王凯
            ...
            //重写读写区的资源信息文件 有以下两种情况
            // 1.如果本地文件系统存储的资源发生变化（某个资源所属的文件系统发生改变 或 某个资源不用了删除了）
            // 2.每次所有资源更新完成 
            //-- by 王凯
            ...
            private void OnDownloadSuccess(object sender, DownloadSuccessEventArgs e)
            {
                ...
                m_UpdatingCount--;
                //这个资源下载完毕之后 标记他在m_ResourceManager.m_ResourceInfos里的状态 意思是标记这个资源已经下载过了 ---by 王凯
            ...
            private void OnDownloadFailure(object sender, DownloadFailureEventArgs e)
            {
                ...
                //TODO 下载流程 updateInfo.RetryCount < m_UpdateRetryCount 下载失败，自动重试下载
