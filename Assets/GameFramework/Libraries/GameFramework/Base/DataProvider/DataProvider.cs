...
namespace GameFramework
{
    ...
    internal sealed class DataProvider<T> : IDataProvider<T>
    {
        ...
        public static int CachedBytesSize
        {
            get
            {
                return Utility.GlobalBuffer.CachedBytesSize;
            }
        }
        ...
        {
            Utility.GlobalBuffer.EnsureCachedBytesSize(ensureSize);
        }
        ...
        {
            Utility.GlobalBuffer.FreeCachedBytes();
        }
        ...
        public void ReadData(string dataAssetName, int priority, object userData)
        {
            ...
            switch (result)
            {
                ...
                case HasAssetResult.BinaryOnFileSystem:
                    ...
                    if (dataLength != m_ResourceManager.LoadBinaryFromFileSystem(dataAssetName, Utility.GlobalBuffer.CachedBytes))
                    {
                    ...
                    try
                    {
                        if (!m_DataProviderHelper.ReadData(m_Owner, dataAssetName, Utility.GlobalBuffer.CachedBytes, 0, dataLength, userData))
                        {
