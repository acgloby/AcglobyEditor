...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private Camera[] m_UICameras = null;
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < m_UIGroups.Length; i++)
            {
                ...
                {
                    Log.Error("Add UI group '{0}' failure.", m_UIGroups[i].Name);
                    continue;
                }
            }
        }
        ...
        {
            Log.Error("Open UI form failure, asset name '{0}', UI group name '{1}', pause covered UI form '{2}', error message '{3}'.", e.UIFormAssetName, e.UIGroupName, e.PauseCoveredUIForm, e.ErrorMessage);
