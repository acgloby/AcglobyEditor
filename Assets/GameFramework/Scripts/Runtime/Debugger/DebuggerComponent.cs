...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        /// 默认调试器窗口缩放比例。
        /// </summary>
        internal static readonly float DefaultWindowScale = (Screen.height - 20f) / 720f < 1f ? 1f : (Screen.height - 20f) / 720f;
        ...
        private void DrawDebuggerWindowGroup(IDebuggerWindowGroup debuggerWindowGroup)
        {
            ...
            int toolbarIndex = GUILayout.Toolbar(debuggerWindowGroup.SelectedIndex, names.ToArray(), GUILayout.Height(30f), GUILayout.MinWidth(WindowRect.width - 100), GUILayout.MaxWidth(WindowRect.width));
