        ...
        private sealed class NetworkInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            private void DrawNetworkChannel(INetworkChannel networkChannel)
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Block Process Packet", networkChannel.BlockProcessPacket.ToString());
                    if (networkChannel.Connected)
                    {
                        if (GUILayout.Button("Block Process Packet", GUILayout.Height(30f)))
                        {
                            networkChannel.BlockProcessPacket = !networkChannel.BlockProcessPacket;
                        }
