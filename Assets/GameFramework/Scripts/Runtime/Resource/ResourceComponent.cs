...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        public void LoadAsset(string assetName, Type assetType, int priority, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            {
                strError = "Asset name is invalid.";
            }

            if (!assetName.StartsWith("Assets/", StringComparison.Ordinal))
            {
                strError = string.Format("Asset name '{0}' is invalid.", assetName);
            }
            ...
            if (strError != string.Empty)
            {
                ...
                {
                    loadAssetCallbacks.LoadAssetFailureCallback(assetName, LoadResourceStatus.PathError, strError, userData);
                }
            }
