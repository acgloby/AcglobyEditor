...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        /// </summary>
        /// <param name="resourceName">Resource 名字</param>
        /// <param name="resourceVariant">Resource 变体</param>
        /// <returns></returns>
        ...
        public bool AssignAsset(string guid, string name, string variant)
        {
            ...
            // 这行就为了检测是不是唯一资源,如果里面包含别的就return false。Resource是LoadFromBinary类型，只能包含一个Asset资源。
        ...
        private bool IsValidResourceName(string name, string variant)
        {
            ...
            {
                Debug.LogError(string.Format( @"无效的BundleName ={0}【只能包含字符A-Za-z0-9\._】", name));
                return false;
            }
