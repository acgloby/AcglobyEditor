...
namespace UnityGameFramework.Editor.ResourceTools
{
    /// <summary>
    /// 资源。 
    /// 一般1个Resource对象，会生成1个AssetBundle包或二进制资源包
    /// IsLoadFromBinary = true，二进制加载，一个Resource只能包含一个Asset资源。（m_Assets.Count = 1）
    /// IsLoadFromBinary = false，从AB加载，一个Resource对象包含n个Asset资源（n >= 1）（m_Assets.Count>=1）
    /// </summary>
