...
namespace UnityGameFramework.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        private const string EnablePrintPacketIDScriptingDefineSymbol = "PRINT_PACKET_ID";
        ...
        /// 启用 打印消息号
        /// </summary>
        [MenuItem("Game Framework/Log Scripting Define Symbols/Enable Print Packet ID", false, 37)]
        public static void EnablePrintPacketID()
        {
            ScriptingDefineSymbols.AddScriptingDefineSymbol(EnablePrintPacketIDScriptingDefineSymbol);
        }

        /// <summary>
        /// 禁用 打印消息号
        /// </summary>
        [MenuItem("Game Framework/Log Scripting Define Symbols/Disable Print Packet ID", false, 38)]
        public static void DisablePrintPacketID()
        {
            ScriptingDefineSymbols.RemoveScriptingDefineSymbol(EnablePrintPacketIDScriptingDefineSymbol);
        }
