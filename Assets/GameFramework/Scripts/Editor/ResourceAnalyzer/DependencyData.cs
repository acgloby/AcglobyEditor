...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    {
        private List<Resource> m_DependencyResources;        //ResourceCollection.xml中的资源
        private List<Asset> m_DependencyAssets;              //ResourceCollection.xml中的资源
        private List<string> m_ScatteredDependencyAssetNames;//游离资源，指不在ResourceCollection.xml中的资源
